...
## Purpose
This project tests the ability to:
- Apply the fundamental of C++ programming
...
## Program Flow
1. Display the menu
2. Prompt user to select a car model
3. Request number of rental hours
4. Validate user inputs
5. Calculate the cost
6. Display a detailed rental summary
